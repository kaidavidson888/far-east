...
const PAIRING_FAMILY = {
  ...
  Soft: ['Espresso', 'Green Tea', 'Ice Water', 'Iced Tea', 'Jasmine Tea', 'Oolong Tea', 'Black Coffee', 'Coffee', 'Mineral Water', 'Herbal Tea', 'Lemonade', 'Black Tea', 'Herbal Broth', 'Tonic'],
...
console.log(`${pages.size} pages -> ${Object.keys(tags).length} packs tagged, ${buttons.length} buttons, wrote ${OUT}`);
